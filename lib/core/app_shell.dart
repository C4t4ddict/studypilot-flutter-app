                  ...
                  child: Column(
                    children: [
                      ...
                      navItem(context, Icons.timer_outlined, '실행력',
                          '/productivity'),
                      const SizedBox(height: 10),
                      navItem(context, Icons.sports_esports_outlined, '게임화',
                          '/gamification'),
                      const SizedBox(height: 10),
                      navItem(context, Icons.psychology_alt_outlined, 'AI 보조',
                          '/ai-assist'),
                      const SizedBox(height: 10),
                      navItem(context, Icons.work_outline_rounded, '취업보드',
                          '/career'),
                      const SizedBox(height: 10),
                      navItem(context, Icons.settings_suggest_outlined, '운영',
                          '/ops'),
                      const Spacer(),
